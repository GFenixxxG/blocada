...
def start_pos():
    ...
    enemy_1 = Enemy(340, 483, 50, 50, 5, enemy_r, "right")
    enemy_2 = Enemy(240, 325, 50, 50, 5, enemy_l, "right")
    enemy_3 = Enemy(300, 157, 50, 50, 5, enemy_l, "right")
    enemy_4 = Enemy(1700, 320, 50, 50, 5, enemy_l, "right")
